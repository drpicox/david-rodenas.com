...
- [The first network](/projects/first-network/) -- a network that tells letters apart, taught by backpropagation, first written in C in 1994; draw on its grid. And the robot of April 1995 that learnt, rule by rule, to look for the light.
