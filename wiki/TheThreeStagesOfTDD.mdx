...
_[TheThreeRulesOfTDD] are quite popular, 
...
![Stages of TDD](/images/testing/stages-of-tdd.png)

### Test

You always start with Test. That is writing tests. 

Follow [TheThreeRulesOfTDD] and write the minimum amount of possible Test. 
...
Probably there is a different set of tests and [StairstepTest]s that might 
