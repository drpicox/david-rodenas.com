---
title: CourseOf React Function
prev: CourseOfReactState
index: CourseOfReact
next: CourseOfReactSelectors
---
...
<div style={{textAlign:'center', maxWidth:'20em', margin:'auto'}}>


![Functional paradigm](/images/view/FunctionalFlow.png)
