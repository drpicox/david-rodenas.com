...
The Release Manager has to make a release for 
each pull request approved by its reviewers.
...
If they doesn't, the bot will assume that you have failed in your task.