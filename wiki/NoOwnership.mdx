...
But the question is, why? Why people stick to ownerships when they are wrong according to Agile and expensive?

The problem is insecurity. No one wants another developer messing with his code and breaking functionalities. No one wants to touch an unknown module and risk to break features. And a kind of agreement appears in which both parts conform to follow individual ownership.
